...
public abstract class BaseApi<T> implements Func1<T, String> {
    ...
    /*基础url*/
//    private  String baseUrl="http://dx.gensaint.com/";
//    private  String baseUrl="http://192.168.0.189:8080/wuya/";
    private  String baseUrl="http://123.57.28.18:8030/BasicInformationCollection/";
//    private  String baseUrl="http://192.168.2.157:8080/BasicInformationCollection/";
    /*是否需要缓存处理*/
