...
public class MyFavoriteProjectLayout extends BaseLayout {
    ...
    public MyFavoriteProjectLayout(Context context) {
        super(context);
    }
    ...
    protected void init() {
        ...
        addressAdapter = new AddressAdapter(mContext, R.layout.item_hot_project, list);
